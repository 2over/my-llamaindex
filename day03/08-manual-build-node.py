# 1.导入核心依赖： LlamaIndex中定义节点、节点关系的基础类
from llama_index.core.schema import TextNode, NodeRelationship, RelatedNodeInfo

# 2. 定义双向关系绑定函数: 核心功能是给两个节点简历【NEXT/PREVIOUS】的双向关联
def link_bidirectional(a: TextNode, b: TextNode, a_note: str, b_note: str):
    """
    给两个TextNode建立双向的NEXT/PREVIOUS关系，并添加描述元数据
    :param a: 第一个文本节点(作为【前序节点】)
    :param b: 第二个文本节点(作为【后序节点】)
    :param a_note: 从a指向b的关系描述(a的NEXT关系)
    :param b_note: 从b指向a的关系描述(b的PREVIOUS关系元数据)
    :return:
    """
...
# id 参数指定节点的唯一ID(也可以不指定， LlamaIndex会自动生成)
node1 = TextNode(text="deepseek", id="1") # 节点1: 文本内容"deepseek", ID为"1"
node2 = TextNode(text="chatgpt", id="2") # 节点2: 文本内容"chatgpt", ID为"2"
